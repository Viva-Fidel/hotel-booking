...
class Hotels(models.Model):
    ...
    amount_of_reviews = models.PositiveIntegerField(default=0)
    recommended_score = models.FloatField(default=0)
...
def hotel_room_photos_path(instance, filename):
    return os.path.join('images/hotels', instance.hotels.hotel_name, instance.name, filename)
